            ...
            <div className='container-xxl flex-grow-1 container-p-y'>
                    ...
                    <div className='d-flex justify-content-between align-items-center'>
                      <div>
                        ...
                        <div className='time-spending-chart'>
                          <h3 className='mb-2'>
                            231<span className='text-muted'>h</span> 14
                        ...
                        <li className='d-flex mb-4 pb-1 align-items-center'>
                          <div className='avatar flex-shrink-0 me-3'>
                            <span className='avatar-initial rounded bg-label-success'>
                              <i className='ti ti-camera ti-md' />
                            </span>
                          </div>
                          <div className='row w-100 align-items-center'>
                            <div className='col-sm-8 col-lg-12 col-xxl-8 mb-1 mb-sm-0 mb-lg-1 mb-xxl-0'>
                        ...
                        <li className='d-flex mb-4 pb-1 align-items-center'>
                          <div className='avatar flex-shrink-0 me-3'>
                            <span className='avatar-initial rounded bg-label-warning'>
                              <i className='ti ti-brand-dribbble ti-md' />
                            </span>
                          </div>
                          <div className='row w-100 align-items-center'>
                            <div className='col-sm-8 col-lg-12 col-xxl-8 mb-1 mb-sm-0 mb-lg-1 mb-xxl-0'>
                        ...
                        <li className='d-flex align-items-center'>
                          <div className='avatar flex-shrink-0 me-3'>
                            <span className='avatar-initial rounded bg-label-danger'>
                              <i className='ti ti-microphone-2 ti-md' />
                            </span>
                          </div>
                          <div className='row w-100 align-items-center'>
                            <div className='col-sm-8 col-lg-12 col-xxl-8 mb-1 mb-sm-0 mb-lg-1 mb-xxl-0'>
                        ...
                        <div className='col-6'>
                          <div className='d-flex'>
                            <div className='avatar flex-shrink-0 me-2'>
                              <span className='avatar-initial rounded bg-label-primary'>
                                <i className='ti ti-calendar-event ti-md' />
                              </span>
                            </div>
                            <div>
              ...
              <div className='card mb-4'>
                <div className='table-responsive mb-3'>
                  <table className='table datatables-academy-course'>
